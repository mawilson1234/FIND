...
#SBATCH --job-name=SCAN-addtwicethrice_jump_train_only-transformer-EL01_DL01-small
...
echo Running script: SCAN_addtwicethrice_jump_train_only_trfm_EL01_DL01_small.sh
